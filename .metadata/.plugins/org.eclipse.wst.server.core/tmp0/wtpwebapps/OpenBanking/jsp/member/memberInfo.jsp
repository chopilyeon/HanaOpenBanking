...
<body>
	...
	<table border="5" style="width:80%" class="m-5 table   w-50 table table-striped table-hover">
		<tr>
			<th width="25%">NAME</th>
			<td>${userVO.name}</td>
		</tr>
		...
		<tr>
			...
			<td><img src="/OpenBanking/resources/images/phone.png" alt="user-img" width="36"
                                    	class="img-circle"><span class="text-white font-medium f-3"></span>${userVO.phoneNumber}	</a>
                        </td>
		...
		<tr>
			...
			<td> <c:if test="${userVO.gender eq 'M' }">
                   
                        
                                <img src="/OpenBanking/resources/images/man.png" alt="user-img" width="36"
                                    class="img-circle"><span class="text-white font-medium f-3"></span></a>
