			    ...
			    <div class="col-lg-12 col-xs-12 text-center">
					<div class="box border border-5 rounded-3 mt-5">
 					 ...
 					 <c:if test="${ userVO.openBanking ne 'Y'}"> 
						...
						<div class="input-group input-group-sm mb-3">
						  <span class="input-group-text" id="inputGroup-sizing-sm">PHONENUMBER OF DEPOSITOR</span>
  						  <input type="text" name="depositPhoneNumber" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
						</div>
