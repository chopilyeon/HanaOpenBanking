...
<body>
	...
	<form action="${pageContext.request.contextPath}/board/writeProcess.do" method="post" name="writeForm" onsubmit="return checkForm()" class="mt-5">
		...
		<table border="1" style="width:80%" class="table border border-4 shadow-lg p-3 mb-5 bg-body rounded">
			<tr>

				<th class="shadow-lg p-3 mb-5 bg-body rounded">TITLE</th>	
				<td><input type="text" name="title" class="form-control input-sm shadow-lg p-3 mb-5 bg-body rounded"></td>  

				
			</tr>
			<tr>
			
				<th width ="25%" class="ml-5 shadow-lg p-3 mb-5 bg-body rounded">WRITER</th>
				<td>${userVO.id }</td> 
			
			</tr>
			<tr>
				<th width ="25%" class="ml-5 shadow-lg p-3 mb-5 bg-body rounded">CONTENT</th>
				<td>
					<textarea rows="5" cols="80" name="content" class="form-control md-textarea"></textarea>
				</td>		
			</tr>
		</table>
		<br>
		<input type="submit" value="WRITE" class="btn btn-secondary">&nbsp;
